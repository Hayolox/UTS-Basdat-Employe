                            ...
                            <div class="card-body">
                               <form method="POST" action="{{ route('deplocation.update',$deplocation->Id_Location) }}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="Dlocation" value="{{ $deplocation->Dlocation }}" name="Dlocation" class="form-control @error('Dlocation') is-invalid @enderror" id="Dlocation" aria-describedby="Dlocation" placeholder="Dlocation">
                                        @error('Dlocation')
                                ...
                                <div class="form-group">
                                        ...
                                        <option value="{{ $deplocation->Dnumber}}" selected>{{ $deplocation->depart->Dname}}</option>
